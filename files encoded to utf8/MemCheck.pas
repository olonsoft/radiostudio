...
Created by: Jean Marc Eber & Vincent Mahon, Sociιtι Gιnιrale, INFI/SGOP/R&D
...
Contact...
	...
	Our address is:
		Tour Sociιtι Gιnιrale
		Infi/Sgop/R&D
		92987 Paris - La Dιfense cedex
		France
...
Disclaimer...
You use MemCheck at your own risks. This means that you cannot hold the authors or Sociιtι Gιnιrale to be
			...
			mov 	eax,[ebp+4];
{
	...
	procedure ReplaceInterfacesWithBadInterface(AClass : TClass; Instance: Pointer);
		...
		@@3:    POP     EBX
				...
				ADD     EBX,4
		@@4:    LEA     ESI, BadInterfaceVMT // mettre dans ESI l'adresse du dιbut de MyInterfaceVMT: correct ?????
...
(*** The hack below arranges for MemCheck's finalization to be called after all others ***)		
  ...
  record
	...
	procedure ChangeFinalizationsOrder;
		...
		- MemCheck will be next (#3) - You could say MemCheck has uses JvFileUtil & Windows, but they have neither finalization nor initialization
		}
		const
